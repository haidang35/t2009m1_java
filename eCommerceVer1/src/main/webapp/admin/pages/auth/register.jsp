...
<%@ page import="com.example.ecommercever1.entity.Account" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <head>
                    ...
                    <form action="/register" method="post">
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                ...
                                <% if(errors.containsKey(ValidationConstant.ACCOUNT_ERROR_KEY_FULL_NAME)) {%>
                                    <div class="invalid-feedback" style="display: block">
                                        <%=errors.get(ValidationConstant.ACCOUNT_ERROR_KEY_FULL_NAME)%>
                                    </div>
                                <% }%>
                            </div>
                            <div class="form-group col-md-12 mb-4">
                            ...
                            <div class="form-group col-md-12 mb-4">
                                <input type="email" class="form-control input-lg" id="email" name="email"
                                       ...
                                       placeholder="Email">
                                <% if(errors.containsKey(ValidationConstant.ACCOUNT_ERROR_KEY_EMAIL)) {%>
                                <div class="invalid-feedback" style="display: block">
                                    <%=errors.get(ValidationConstant.ACCOUNT_ERROR_KEY_EMAIL)%>
                                </div>
                                <% }%>
                            </div>
                            <div class="form-group col-md-12 mb-4">
                                <input type="tel" class="form-control input-lg" id="phoneNumber" name="phoneNumber"
                                       value="<%=account.getPhoneNumber()%>"
                                       placeholder="Phone Number">
                                <% if(errors.containsKey(ValidationConstant.ACCOUNT_ERROR_KEY_PHONE_NUMBER)) {%>
                                <div class="invalid-feedback" style="display: block">
                                    <%=errors.get(ValidationConstant.ACCOUNT_ERROR_KEY_PHONE_NUMBER)%>
                                </div>
                                <% }%>
                            </div>
                            ...
                            <div class="form-group col-md-12 ">
                                ...
                                <% if(errors.containsKey(ValidationConstant.ACCOUNT_ERROR_KEY_CONFIRM_PASSWORD)) {%>
                                <div class="invalid-feedback" style="display: block">
                                    <%=errors.get(ValidationConstant.ACCOUNT_ERROR_KEY_CONFIRM_PASSWORD)%>
                                </div>
                                <% }%>
                            </div>
                            <div class="col-md-12">
