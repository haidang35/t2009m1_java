package com.example.ecommercever1.util;
...
public class LanguageHelper {
    ...
    private static String country = "VI";
    ...
    public static void setLang(String lang) {
        LanguageHelper.lang = lang;
    }

    public static void setCountry(String country) {
        LanguageHelper.country = country;
    }

    public static void setDefaultLocale(String lang, String country) {
        Locale.setDefault(new Locale(lang, country));
    }
