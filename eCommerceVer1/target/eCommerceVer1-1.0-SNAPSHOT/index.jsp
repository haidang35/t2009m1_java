...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 May 2022 06:49:13 GMT -->
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="dropdownmenu-wrapper custom-scrollbar">
                                ...
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="demo1-product.html" class="product-image">
                                                <img src="/public/assets/images/products/product-1.jpg" alt="product" width="80" height="80">
                                            </a>
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="demo1-product.html" class="product-image">
                                                <img src="/public/assets/images/products/product-2.jpg" alt="product" width="80" height="80">
                                            </a>
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="demo1-product.html" class="product-image">
                                                <img src="/public/assets/images/products/product-3.jpg" alt="product" width="80" height="80">
                                            </a>
                                            <a href="#" class="btn-remove" title="Remove Product"><span>×</span></a>
                                        </figure>
                                    </div>
                ...
                <div class="col-lg-9">
                    <div class="home-slider slide-animate owl-carousel owl-theme mb-2" data-owl-options="{
                        ...
                        <div class="home-slide home-slide1 banner banner-md-vw banner-sm-vw d-flex align-items-center">
                            <img class="slide-bg" style="background-color: #2699D0;" src="/public/assets/images/demoes/demo1/slider/slide-1.png" width="880" height="428" alt="home-slider">
                        ...
                        <div class="home-slide home-slide2 banner banner-md-vw banner-sm-vw d-flex align-items-center">
                            <img class="slide-bg" style="background-color: #dadada;" src="/public/assets/images/demoes/demo1/slider/slide-2.jpg" width="880" height="428" alt="home-slider">
                        ...
                        <div class="home-slide home-slide3 banner banner-md-vw banner-sm-vw  d-flex align-items-center">
                            <img class="slide-bg" style="background-color: #e5e4e2;" src="/public/assets/images/demoes/demo1/slider/slide-3.jpg" width="880" height="428" alt="home-slider" />
                            <div class="banner-layer text-uppercase appear-animate" data-animation-name="fadeInUpShorter">
                    ...
                    <div class="banners-container m-b-2 owl-carousel owl-theme" data-owl-options="{
                        ...
                        <div class="banner banner1 banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="500">
                            <figure class="w-100">
                                <img src="/public/assets/images/demoes/demo1/banners/banner-1.jpg" style="background-color: #dadada;" alt="banner">
                            </figure>
                        ...
                        <div class="banner banner2 text-uppercase banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="200">
                            <figure class="w-100">
                                <img src="/public/assets/images/demoes/demo1/banners/banner-2.jpg" style="background-color: #dadada;" alt="banner">
                            </figure>
                        ...
                        <div class="banner banner3 banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate" data-animation-name="fadeInRightShorter" data-animation-delay="500">
                            <figure class="w-100">
                                <img src="/public/assets/images/demoes/demo1/banners/banner-3.jpg" style="background-color: #dadada;" alt="banner">
                            </figure>
                    ...
                    <div class="products-slider owl-carousel owl-theme dots-top dots-small m-b-1 pb-1 appear-animate" data-animation-name="fadeInUpShorter">
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="/public/assets/images/demoes/demo1/products/product-1.jpg" width="205" height="205" alt="product">
                                    <img src="/public/assets/images/demoes/demo1/products/product-1-2.jpg" width="205" height="205" alt="product">
                                </a>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="/public/assets/images/demoes/demo1/products/product-2.jpg" width="205" height="205" alt="product" />
                                </a>
                                <div class="btn-icon-group">
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="/public/assets/images/demoes/demo1/products/product-3.jpg" width="205" height="205" alt="product">
                                    <img src="/public/assets/images/demoes/demo1/products/product-3-2.jpg" width="205" height="205" alt="product">
                                </a>
                                <div class="label-group">
                                    <div class="product-label label-hot">HOT</div>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="/public/assets/images/demoes/demo1/products/product-4.jpg" width="205" height="205" alt="product">
                                    <img src="/public/assets/images/demoes/demo1/products/product-4-2.jpg" width="205" height="205" alt="product">
                                </a>
                                <div class="label-group">
                                    <div class="product-label label-hot">HOT</div>
                                </div>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="/public/assets/images/demoes/demo1/products/product-5.jpg" width="205" height="205" alt="product">
                                    <img src="/public/assets/images/demoes/demo1/products/product-5-2.jpg" width="205" height="205" alt="product">
                                </a>
                                <div class="label-group">
                                    <div class="product-label label-hot">HOT</div>
                                </div>
                    ...
                    <div class="brands-slider owl-carousel owl-theme images-center appear-animate" data-animation-name="fadeIn" data-animation-duration="700" data-owl-options="{
                        ...
                        <img src="/public/assets/images/brands/small/brand1.png" width="140" height="60" alt="brand">
                        <img src="/public/assets/images/brands/small/brand2.png" width="140" height="60" alt="brand">
                        <img src="/public/assets/images/brands/small/brand3.png" width="140" height="60" alt="brand">
                        <img src="/public/assets/images/brands/small/brand4.png" width="140" height="60" alt="brand">
                        <img src="/public/assets/images/brands/small/brand5.png" width="140" height="60" alt="brand">
                        <img src="/public/assets/images/brands/small/brand6.png" width="140" height="60" alt="brand">
                    </div>
                    <!-- End .brands-slider -->
                        ...
                        <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="200">
                            <div class="product-column">
                                ...
                                <div class="product-default left-details product-widget">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-4.jpg" width="84" height="84" alt="product">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-4-2.jpg" width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-5.jpg" width="84" height="84" alt="product">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-5-2.jpg" width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-6.jpg" width="84" height="84" alt="product">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-6-2.jpg" width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                        ...
                        <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="500">
                            <div class="product-column">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-2.jpg" width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-7.jpg" width="84" height="84" alt="product">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-7-2.jpg" width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-8.jpg" width="84" height="84" alt="product">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-8-2.jpg" width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                        ...
                        <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="800">
                            <div class="product-column">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-9.jpg" width="84" height="84" alt="product">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-9-2.jpg" width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-10.jpg" width="84" height="84" alt="product">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-10-2.jpg" width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget ">
                                    <figure>
                                        <a href="demo1-product.html">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-11.jpg" width="84" height="84" alt="product">
                                            <img src="/public/assets/images/demoes/demo1/products/small/product-11-2.jpg" width="84" height="84" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="demo1-product.html">Brown-Black Men
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner">
                                                    <figure>
                                                        <img src="/public/assets/images/menu-banner.jpg" width="192" height="313" alt="Menu banner">
                                                    </figure>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner menu-banner-2">
                                                    <figure>
                                                        <img src="/public/assets/images/menu-banner-1.jpg" alt="Menu banner" class="product-promo">
                                                    </figure>
                                                    <i>OFF</i>
                                                    <div class="banner-content">
                                                        <h4>
                    ...
                    <div class="widget widget-banners px-3 pb-3 text-center">
                        <div class="owl-carousel owl-theme dots-small">
                            ...
                            <div class="banner banner4">
                                <figure>
                                    <img src="/public/assets/images/demoes/demo1/banners/banner-7.jpg" alt="banner">
                                </figure>
                            ...
                            <div class="banner banner5">
                                ...
                                <figure class="m-b-3">
                                    <img src="/public/assets/images/demoes/demo1/banners/banner-8.jpg" alt="banner">
                                </figure>
                        ...
                        <div class="owl-carousel owl-theme dots-left dots-small">
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="/public/assets/images/clients/client-1.jpg" alt="client">
                                    </figure>
                            ...
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="/public/assets/images/clients/client-2.jpg" alt="client">
                                    </figure>
                            ...
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="/public/assets/images/clients/client-3.jpg" alt="client">
                                    </figure>
                        ...
                        <div class="owl-carousel owl-theme dots-left dots-m-0 dots-small" data-owl-options="
                            ...
                            <article class="post">
                                <div class="post-media">
                                    <a href="single.html">
                                        <img src="/public/assets/images/blog/home/post-1.jpg" data-zoom-image="/public/assets/images/blog/home/post-1.jpg" width="280" height="209" alt="Post">
                                    </a>
                                    <div class="post-date">
                            ...
                            <article class="post">
                                <div class="post-media">
                                    <a href="single.html">
                                        <img src="/public/assets/images/blog/home/post-2.jpg" data-zoom-image="/public/assets/images/blog/home/post-2.jpg" width="280" height="209" alt="Post">
                                    </a>
                                    <div class="post-date">
                                        <span class="day">29</span>
                                        <span class="month">Jun</span>
                            ...
                            <article class="post">
                                <div class="post-media">
                                    <a href="single.html">
                                        <img src="/public/assets/images/blog/home/post-3.jpg" data-zoom-image="/public/assets/images/blog/home/post-3.jpg" width="280" height="209" alt="Post">
                                    </a>
                                    <div class="post-date">
                                        <span class="day">29</span>
                                        <span class="month">Jun</span>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 pb-2 pb-sm-0">
                        <div class="widget">
                            ...
                            <a href="demo1.html">
                                <img src="/public/assets/images/logo-footer.png" alt="Logo" class="logo-footer">
                            </a>
            ...
            <div class="footer-bottom d-sm-flex align-items-center">
                ...
                <div class="footer-right ml-auto mt-1 mt-sm-0">
                    <div class="payment-icons">
                        <span class="payment-icon visa" style="background-image: url(/public/assets/images/payments/payment-visa.svg)"></span>
                        <span class="payment-icon paypal" style="background-image: url(/public/assets/images/payments/payment-paypal.svg)"></span>
                        <span class="payment-icon stripe" style="background-image: url(/public/assets/images/payments/payment-stripe.png)"></span>
                        <span class="payment-icon verisign" style="background-image:  url(/public/assets/images/payments/payment-verisign.svg)"></span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="newsletter-popup mfp-hide bg-img" id="newsletter-popup-form" style="background: #f1f1f1 no-repeat center/cover url(/public/assets/images/newsletter_popup_bg.jpg)">
    <div class="newsletter-popup-content">
        <img src="/public/assets/images/logo.png" width="111" height="44" alt="Logo" class="logo-newsletter">
...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 May 2022 06:49:48 GMT -->
</html>
