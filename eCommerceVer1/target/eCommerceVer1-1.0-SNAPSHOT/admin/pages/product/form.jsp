<%@ page import="com.example.ecommercever1.entity.entityEnum.FormAction" %>
...
<%@ page import="com.example.ecommercever1.entity.entityEnum.CategoryStatus" %>
<%@ page import="com.example.ecommercever1.entity.Product" %>
<%@ page import="com.example.ecommercever1.entity.entityEnum.ProductStatus" %>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control " id="name"
                                                   placeholder="Product Name" name="name" value="<%= product.getName() %>"
                                            >
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control " id="thumbnail"
                                                   placeholder="Thumbnail" name="thumbnail" value="<%= product.getThumbnail() %>"
                                            >
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="number" class="form-control " id="price"
                                                   placeholder="Thumbnail" name="price" value="<%= product.getPrice() %>"
                                            >
